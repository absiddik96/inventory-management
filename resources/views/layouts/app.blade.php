                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#"
                                class="nav-link {{ Request::is('daily-records*') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <!-- record -->
                                <li class="nav-item">
                                    <a href="{{ route('user.daily-records.index') }}"
                                        class="nav-link {{ Request::is('daily-records') ? 'active' : '' }}">
                                ...
                                <!-- Archive -->
                                <li class="nav-item">
                                    <a href="{{ route('daily-records.archive') }}"
                                        class="nav-link {{ Request::is('daily-records/archive') ? 'active' : '' }}">
