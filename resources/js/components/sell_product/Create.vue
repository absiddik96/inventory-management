                            ...
                            <tbody>
                                <tr v-for="(p_item,index) in form.sell_items" :key="index">
                                    ...
                                    <td style="display: flex">
                                        <input required style="padding-right:30%" @keyup.prevent="grandTotal()" type="number" class="form-control" :class="{'is-invalid':parseInt(p_item.quantity)>parseInt(p_item.packet_size.packet_quantity)}" v-model="p_item.quantity">  <p style="margin: 7px 0 -7px -27%">/ {{ p_item.packet_size.packet_quantity?p_item.packet_size.packet_quantity:0 }}</p>
                                    </td>
