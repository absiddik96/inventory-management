                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(p_item,index) in form.purchase_items" :key="index">
                                    ...
                                    <td>{{ p_item.name }}</td>
                                    <td>
                                        <input @keyup="grandTotal" step="0.01" type="number" class="form-control" v-model="p_item.quantity" required>
                                    </td>
                                    <td>
                                        <input @keyup="grandTotal" step="0.01" type="number" class="form-control" v-model="p_item.unit_price" required>
                                    </td>
